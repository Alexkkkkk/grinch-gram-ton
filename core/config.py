...
class GridConfig:
    ...
    symbol: str = field(
        default_factory=lambda: _str_env("GRID_SYMBOL_DEDUST", "GRAM/USDT")
    )
...
class Config(metaclass=_ConfigMeta):
    ...
    def __init__(self):
        ...
        self.AI_TP_ADAPT_MIN_TRADES = _int_env("AI_TP_ADAPT_MIN_TRADES", 5)
        self.AI_TP_CAP_PCT = _float_env("AI_TP_CAP_PCT", 60.0)
        self.DCA_AI_TARGET_CAP = _float_env("DCA_AI_TARGET_CAP", 80.0)
        ...
        self.GRID_SYMBOL_BINANCE = _str_env("GRID_SYMBOL_BINANCE", "GRAMUSDT")
        ...
        self.FEES = FeeConfig()
        self.SLIPPAGE_PCT = self.FEES.slippage

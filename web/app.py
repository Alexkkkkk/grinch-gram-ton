...
def create_app() -> Flask:
    ...
    # Start real-time price feed from STON.fi
    try:
        from core.price_feed_real import start_background_updates, update_price

        update_price()  # initial fetch
        start_background_updates()
    except Exception as e:
        logger.warning("[App] Could not start price feed: %s", e)
